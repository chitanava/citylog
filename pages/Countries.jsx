    ...
    return (
        <>
            <div className="my-8">
                ...
                <p className="text-center">You've explored 10 countries so far</p>
                <p className="text-sm text-base-content/60 text-center">a true traveler at heart!</p>
            </div>

            <ul>
                <li className="flex gap-4 items-center px-6 mb-8">
                    <img
                    ...
                    <div className="flex-1">
                        <div>France</div>
                        <div className="text-sm text-base-content/60">You have visited 12 cityes</div>
                    </div>
                </li>
